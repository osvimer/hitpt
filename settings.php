...
if ($action == 'savesettings_main')	// save main
{
	...
	$validConfig = array('site_online','max_torrent_size','announce_interval', 'annintertwoage', 'annintertwo', 'anninterthreeage', 'anninterthree', 'signup_timeout','minoffervotes','offervotetimeout','offeruptimeout','maxsubsize','postsperpage', 'topicsperpage', 'torrentsperpage', 'maxnewsnum','max_dead_torrent_time','maxusers','torrent_dir', 'iniupload','iniseedbonus','SITEEMAIL', 'ACCOUNTANTID', 'ALIPAYACCOUNT', 'PAYPALACCOUNT', 'SLOGAN', 'icplicense', 'autoclean_interval_one', 'autoclean_interval_two', 'autoclean_interval_three','autoclean_interval_four', 'autoclean_interval_five','reportemail','invitesystem','loginadd','cardreg','registration','showhotmovies','showclassicmovies','showimdbinfo', 'enablenfo', 'enableschool','restrictemail','showpolls','showstats','showlastxtorrents', 'showtrackerload','showshoutbox','showfunbox','showoffer','sptime','showhelpbox','enablebitbucket', 'smalldescription','altname','extforum','extforumurl','defaultlang','defstylesheet', 'donation','spsct','browsecat','specialcat','waitsystem','maxdlsystem','bitbucket','torrentnameprefix', 'showforumstats','verification','invite_count','invite_timeout', 'seeding_leeching_time_calc_start','startsubid', 'logo');
	GetVar($validConfig);
	unset($MAIN);
...
elseif ($action == 'torrentsettings')
{
	...
	tr($lang_settings['row_movie_torrent_promotion'], $lang_settings['text_cat_promoted_to']."<select name=moviepro>".promotion_selection_for_cat((isset($TORRENT['moviepro']) ? $TORRENT['moviepro'] : 0))."</select><br />".$lang_settings['text_cat_promotion_note'], 1);
	tr($lang_settings['row_tvshow_torrent_promotion'], $lang_settings['text_cat_promoted_to']."<select name=tvshowpro>".promotion_selection_for_cat((isset($TORRENT['tvshowpro']) ? $TORRENT['tvshowpro'] : 0))."</select><br />", 1);
	tr($lang_settings['row_cartoon_torrent_promotion'], $lang_settings['text_cat_promoted_to']."<select name=cartoonpro>".promotion_selection_for_cat((isset($TORRENT['cartoonpro']) ? $TORRENT['cartoonpro'] : 0))."</select><br />", 1);
	tr($lang_settings['row_documentary_torrent_promotion'], $lang_settings['text_cat_promoted_to']."<select name=documentarypro>".promotion_selection_for_cat((isset($TORRENT['documentarypro']) ? $TORRENT['documentarypro'] : 0))."</select><br />", 1);
	tr($lang_settings['row_variety_torrent_promotion'], $lang_settings['text_cat_promoted_to']."<select name=varietypro>".promotion_selection_for_cat((isset($TORRENT['varietypro']) ? $TORRENT['varietypro'] : 0))."</select><br />", 1);
	tr($lang_settings['row_sports_torrent_promotion'], $lang_settings['text_cat_promoted_to']."<select name=sportspro>".promotion_selection_for_cat((isset($TORRENT['sportspro']) ? $TORRENT['sportspro'] : 0))."</select><br />", 1);
	tr($lang_settings['row_music_torrent_promotion'], $lang_settings['text_cat_promoted_to']."<select name=musicpro>".promotion_selection_for_cat((isset($TORRENT['musicpro']) ? $TORRENT['musicpro'] : 0))."</select><br />", 1);
	tr($lang_settings['row_software_torrent_promotion'], $lang_settings['text_cat_promoted_to']."<select name=softwarepro>".promotion_selection_for_cat((isset($TORRENT['softwarepro']) ? $TORRENT['softwarepro'] : 0))."</select><br />", 1);
	tr($lang_settings['row_game_torrent_promotion'], $lang_settings['text_cat_promoted_to']."<select name=gamepro>".promotion_selection_for_cat((isset($TORRENT['gamepro']) ? $TORRENT['gamepro'] : 0))."</select><br />", 1);
	tr($lang_settings['row_study_torrent_promotion'], $lang_settings['text_cat_promoted_to']."<select name=studypro>".promotion_selection_for_cat((isset($TORRENT['studypro']) ? $TORRENT['studypro'] : 0))."</select><br />", 1);
	tr($lang_settings['row_others_torrent_promotion'], $lang_settings['text_cat_promoted_to']."<select name=otherspro>".promotion_selection_for_cat((isset($TORRENT['otherspro']) ? $TORRENT['otherspro'] : 0))."</select><br />", 1);
