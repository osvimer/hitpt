...
(
	...
	'row_post_funbox_item' => "發布每日学堂內容",
	'text_post_funbox_item_note' => "。允許發布新的每日学堂內容及編輯自己發布的每日学堂內容。",
	'row_funbox_management' => "管理每日学堂",
	'text_funbox_management_note' => "。編輯、移除、禁止任何人發布的每日学堂內容。",
	...
	'text_voting_on_funbox_note' => "個魔力值，如果他參與一次每日学堂投票。預設'1'。",
	...
	'row_funbox_stuff_reward' => "每日学堂獎勵",
	'text_funbox_stuff_reward_note' => "個魔力值，如果他發布的每日学堂內容被評為“有趣”。預設'5'。",
	...
	'row_show_funbox' => "察看每日学堂",
	'text_show_funbox_note' => "預設'否'。在首頁察看每日学堂。",
