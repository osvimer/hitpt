...
(
	...
	'row_post_funbox_item' => "发布每日学堂内容",
	'text_post_funbox_item_note' => "。允许发布新的每日学堂内容及编辑自己发布的每日学堂内容。",
	'row_funbox_management' => "管理每日学堂",
	'text_funbox_management_note' => "。编辑、删除、禁止任何人发布的每日学堂内容。",
	...
	'text_general_profile_management_note' => "。改变用户的基本档案，但不能改变其中重要的项目，如邮箱地址、用户名、上传量、下载量、魔力值。",
	...
	'row_voting_on_funbox' => "每日学堂投票",
	'text_voting_on_funbox_note' => "个魔力值，如果他参与一次每日学堂投票。默认'1'。",
	'row_saying_thanks' => "说谢谢",
	'text_giver_and_receiver_get' => "感谢表达者和接受者将分别得到",
	'text_saying_thanks_and' => "和",
	'text_saying_thanks_default' => "个魔力值。默认'0.5'，'0'。(切记:一定要将二者的绝对值设为相等)",
	'row_funbox_stuff_reward' => "每日学堂奖励",
	'text_funbox_stuff_reward_note' => "个魔力值，如果他发布的每日学堂内容被评为“有趣”。默认'5'。",
	...
	'row_movie_torrent_promotion' => "电影类资源自动促销",
	'row_tvshow_torrent_promotion' => "电视剧集类资源自动促销",
	'row_cartoon_torrent_promotion' => "动漫类资源自动促销",
	'row_documentary_torrent_promotion' => "纪录片类资源自动促销",
	'row_variety_torrent_promotion' => "综艺类资源自动促销",
	'row_sports_torrent_promotion' => "体育类资源自动促销",
	'row_music_torrent_promotion' => "音乐类资源自动促销",
	'row_software_torrent_promotion' => "软件类资源自动促销",
	'row_game_torrent_promotion' => "游戏类资源自动促销",
	'row_study_torrent_promotion' => "学习类资源自动促销",
	'row_others_torrent_promotion' => "其他类资源自动促销",
	'text_cat_promoted_to' => "该类资源在发布时由系统自动设为",
	'text_cat_promotion_note' => "默认为'不使用此规则'。 出于鼓励用户下载做种大体积资源的目的，本规则的优先级低于'大体积种子促销'规则。适用于'XX类资源自动促销'规则<br />比如:电影类资源自动促销设为30%，大体积种子促销设为大于10GB的资源免费，则一个15GB的电影资源系统将自动设为免费。",
	...
	'text_initial_seedbonus_amount_note' => "单位为个。新注册用户的初始魔力值。默认'500'。",
    ...
    'row_allow_cardreg' => "若开启此选项请将用户验证方式设为自动。若开启，则允许哈工大校内用户通过校内IP认证注册。默认'是'。",
	...
	'text_show_classic_note' => "默认'否'。在首页显示经典资源。只有指定的协理员或以上等级能够挑选热门资源。",
	...
	'row_show_funbox' => "显示每日学堂",
	'text_show_funbox_note' => "默认'否'。在首页显示每日学堂。",
	...
	'text_external_forum_url_note' => "填写类似这样的地址：http://www.hit.edu.cn",
