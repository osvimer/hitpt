...
(
	...
	'std_invalid_onecard' => "您的学号(工号)或校园信息平台密码错误！",
	...
	'std_username_too_long' => "对不起，用户名过长（至多14个字符）",
	'std_username_too_short' => "对不起，用户名过短（至少4个字符）",
	...
	'std_invalid_username' => "无效的用户名，用户名只允许为中文、英文或数字。",
	...
	'mail_four_1' => "<br /><br />如果以上链接打开出错或不存在，请尝试将链接复制到浏览器地址栏并打开；如果已经过期, 尝试在这里重新发送确认邮件 ",
