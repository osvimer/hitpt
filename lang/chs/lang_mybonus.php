...
(
	...
	'text_upload' => "每上传1K，将增加0.00001点魔力值。即每上传100M，增加1.024点魔力值(按实际上传量计算，例如：不计算2倍等上传量)",
	'text_down' => "每下载1K，将减少0.000012点魔力值。即每下载100M，减少1.2288点魔力值(按虚拟下载量计算，例如：0.5下载只计算一半的下载量)",
	'text_get_by_updown' => "你的上传量或下载量将对魔力值产生如下影响",
...
式中<ul><li><b>A</b>为中间变量</li><li><b>Ti</b>为第<b>i</b>个种子的生存时间, 即自种子发布起到现在所经过的时间, 单位是周</li><li><b>T0</b>为参数。<b>T0</b> = ",
	...
	'text_per_hour' => "",
	'text_custom' => "自定义",
	'bonus_amount_not_allowed' => "魔力值数量不允许。你每次只能赠送25至1000个魔力值。",
