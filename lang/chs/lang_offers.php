...
(
	...
	'row_type' => "类型",
	'row_title' => "标题",
	'text_title_note' => "(<b>要求规范填写</b>，如<i>Kung Fu 2004 BluRay 1080p DTS x264-WiKi</i> )",
	...
	'text_small_description_note' => "(将在候选页面的标题下显示。如<i>哥伦比亚人/魅影杀机(港)/黑兰煞(台)[未分级 美版]</i> )",
	...
	'std_must_enter_small_description' => "你必须输入副标题！",
	...
	'text_offer_note1' => "<a href=http://pt.hit.edu.cn/forums.php?action=viewtopic&topicid=323&page=0><font color=brown size=+2>为了您的种子早日通过审核，请先认真学习PT规则！点击进入...</font></a>",
	'text_offer_note2' => "<a href=http://pt.hit.edu.cn/forums.php?action=viewtopic&forumid=2&topicid=538><font color=brown size=+2>发布候选前请务必阅读命名规则！点击进入...</font></a>",
	'text_offer_note1' => "<font color=brown size=+2>为了您的种子早日通过审核，请先认真学习PT规则！</font>",
	'text_offer_note2' => "<font color=brown size=+2>发布候选前请务必阅读命名规则！</font>",
	'text_add_offer' => "确定无重复种子，点击此处开始添加候选",
	'text_view_request' => "查看求种",
	'select_show_all' => "(显示全部)",
	'submit_view_only_selected' => "显示选择",
	'text_search_offers' => "搜索：",
	//'text_search_offer_note' => "<font size=+1 color=red>为避免重复发种，请务必提前搜索种子是否已经存在，确定无重复方可添加，否则请直接下载种子保种，违者重罚(根据用户等级处以扣1000至4000魔力值处罚，举报有奖)</font><br/>",
	'title_comment' => "评论",
	'col_vote_results' => "投票",
