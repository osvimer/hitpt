...
(
	'std_access_denied' => "对不起，您的权限不允许访问。",
	...
	'std_not_xiaonei_ip' => "对不起，此功能仅对哈工大校园网用户开放。如果你是校外用户，请等待我们的开放注册时间:)感谢您对清影PT的关注。",
	...
	'std_cannot_find_at_user' => "您要 @ 的用户不存在，请重新输入",
	...
	'js_prompt_enter_flash_url' => "你必须输入一个完整的Flash的URL",
	...
	'text_elite_user' => "硕士",
	'text_crazy_user' => "博士",
	'text_insane_user' => "博士后",
	'text_veteran_user' => "教授",
	'text_extreme_user' => "硕导",
	'text_ultimate_user' => "博导",
	'text_nexus_master' => "院士",
	'text_vip' => "贵宾",
	'text_uploader' => "发布员",
	'text_retiree' => "养老族",
	...
	'text_about' => "站点维护：<a href=http://pt.hit.edu.cn target=_blank>清影PT</a><br />"
);
