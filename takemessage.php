...
if ($_SERVER["REQUEST_METHOD"] != "POST")
	...
	$at_text = is_include_at($msg);
	if($at_text)
	{
		$at_title = htmlspecialchars($subject);
	  	$at_text = "在 ".$CURUSER["username"]." 发给 ".$user['username']." 的短消息 ".$at_title." 中,
".$CURUSER["username"].$lang_takemessage['text_at_you'].":  ".htmlspecialchars($at_text);
		at_user_message($at_text, $at_title, "message");
	}
