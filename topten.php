...
function bonustable($res, $frame_caption)
{
	...
	{
		//die();
		print("<tr><td class=\"rowfollow\" align=\"center\">$n</td><td class=\"rowfollow\" align=\"left\">" . get_username($arr["id"]) . "</td><td class=\"rowfollow\" align=\"right\">" . number_format((int)$arr["seedbonus"], 1) . "</td></tr>\n");
		$n++;
	}
