...
while ($friend = mysql_fetch_array($res))
{
	...
	print("<table width=100% height=75px class=tablea>");
...
print("<br /><br />");
print("<table width=1200 border=0 cellspacing=0 cellpadding=5><tr><td class=embedded>");
