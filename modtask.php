...
if ($action == "edituser")
{
	...
	$seedkeeper = $_POST["seedkeeper"];
	$ambassador = $_POST["ambassador"];
	$artmember = $_POST["artmember"];
	$pickfor = $_POST["pickfor"];
	$seedfor = $_POST["seedfor"];
	$ambassadorfor = $_POST["ambassadorfor"];
	$artmemberfor = $_POST["artmemberfor"];	
	...
	$updateset[] = "seedfor = " . sqlesc($seedfor);
	$updateset[] = "seedkeeper = " . sqlesc($seedkeeper);
	$updateset[] = "ambassadorfor = " . sqlesc($ambassadorfor);
	$updateset[] = "ambassador = " . sqlesc($ambassador);
	$updateset[] = "artmemberfor = " . sqlesc($artmemberfor);
	$updateset[] = "artmember = " . sqlesc($artmember);
