...
{
	if ($_POST['doit'] == 'yes') {
		sql_query("UPDATE users SET seedbonus = seedbonus + 500 WHERE status='confirmed'");
		stderr("Bonus", "500 bonus point is sent to everyone...");
		die;
	}
...
<?php end_main_frame();?>
<?php begin_main_frame("Send 500 bonus point to everyone",false,30);?>
<form action="amountbonus.php" method="post">
<table width=100% border=1 cellspacing=0 cellpadding=5>
<tr><td class="rowfollow" width="100%">
Are you sure you want to give all confirmed users 500 extra bonus point?<br /><br /></td></tr>
