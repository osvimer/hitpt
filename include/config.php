...
$moviepro_torrent = $TORRENT['moviepro'];
$tvshowpro_torrent = $TORRENT['tvshowpro'];
$cartoonpro_torrent = $TORRENT['cartoonpro'];
$documentarypro_torrent = $TORRENT['documentarypro'];
$varietypro_torrent = $TORRENT['varietypro'];
$sportspro_torrent = $TORRENT['sportspro'];
$musicpro_torrent = $TORRENT['musicpro'];
$softwarepro_torrent = $TORRENT['softwarepro'];
$gamepro_torrent = $TORRENT['gamepro'];
$studypro_torrent = $TORRENT['studypro'];
$otherspro_torrent = $TORRENT['otherspro'];
